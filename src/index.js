...
app.use(async ctx => {
    ...
    console.log(styles.red[0] + styles.green[0], "timestamp: ", Date.now());
    ...
    console.log(styles.red[0] + styles.green[0], "query:  ", ctx.querystring);
    ...
    console.log(styles.cyan[0] + styles.green[0], "timestamp: ", Date.now());
